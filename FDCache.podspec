#
#  Be sure to run `pod spec lint FDCache.podspec' to ensure this is a
...
keey it simple and tiny.
  ...
  s.source       = { :git => "https://github.com/toolazytoname/FDCache.git", :tag => "#{s.version}" }
